...
public class MainWarunki
{
    public static void main(String[] args)
    {
        ...
        // 2. M przypadku pracy z passzportami,
        ...
        // Aby wpisać coś do konsoli
        // użyj funkcji System.out.println(twojaZmiennaTutaj);
        ...
        // Aby wybrać drogę w lewo, prowadzącą przez granicę, musimy posiadać paszport
        ...
        // Wywnioskować z powyższej definicji możemy że:
        // 1. Warunek jest "blokadą", która otworzy nam się tylko kiedy jakiś konkrenty wymóg zostanie spełniony.
        // 2. Warunek jest sytuacją w której robimy albo jedno albo drugie. Jeśli spełniliśmy wymóg to możemy przejść daną ścieżką
        ...
        // W przeciwnym razie, jeśli wiek osoby będzie mniejszy niż 18 lat to wejdziemy do ścieżki "else" gdzie zabronimy kupna alkoholu.
...
//         }
        ...
        // Stwórz warunek w którym sprawdzisz czy zmienna z wiekiem osoby jest większa lub równa niż 18 lat.
        ...
        // Zastanawiają się czy starczy im pieniędzy na dwie paczki chrupków.
        // Zosia ma przy sobie 5 zł a Wojtek ma o 2 zł mniej
        // Jedna paczka chrupków kosztuje 5 zł.
        // Utwórz warunek, który sprawdzi czy suma pieniędzy posiadanych przez dzieci wystarczy im do kupna dwóch paczek chrópków
        // Jeśli tak to wypisz w konsoli zdanie "Zosia i Wojtek mogą kupić dwie paczki chrupków"
        // Jeśli nie to wypisz w konsoli zdanie "Zosia i Wojtek nie mogą kupić dwóch paczek chrupków"



        // Zadanie 4.
        // Utwórz zmienną przechowującą słowo "Programowanie"
        // Sprawdź w warunku czy zmienna ta jest równa słowu "programowanie" (słowo z małej litery)
